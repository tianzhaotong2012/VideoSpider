...
foreach($all_video as $item){
    ...
    echo sprintf("<div><a href=%s><img src=%s/><p>%s</p></a></div>",'http://m.shixunkuaibao.com/VideoSpider/play1.php?video_url='.$item['video_url'].'&image_url='.$item['image_url'].'&title='.$item['title'],$item['image_url'],$item['title']);
}